...
SECRET_KEY='django-insecure-732zv-)6x@hi_ci_1kp$dvl@4@d)@n%y4^z(kq$&=^az8sb&+)'
...
CSRF_TRUSTED_ORIGINS = ['http://localhost:3000', 'https://*.127.0.0.1', 'http://*localhost:3000', 'http://127.0.0.1', 'http://127.0.0.1/']
